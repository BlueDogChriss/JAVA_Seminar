...
public abstract class Publicatie implements Comparable<Publicatie>,Cloneable, Serializable {
    ...
    public Publicatie(String titlu, String cota, String editura, int anAparitie, double valoareInventar) throws Exception{
        if (anAparitie>2021){
    ...
    public String toString() {
        return "Publicatie {" +titlu + "," + cota + "," + editura + "," + anAparitie +"," + valoareInventar +
    ...
    public Object clone() throws CloneNotSupportedException {
        Publicatie copie = (Publicatie) super.clone();
        copie.setDomenii(domenii.clone());
        return copie;
    }
}
